...
To add common voiceline you will need a directory named "voices" in your ccg_mod root directory. 
...
For examples go to: [Voices directory](../mod_hexer/ccg_mod/voices)