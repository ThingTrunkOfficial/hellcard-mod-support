...
The starting influence can be found here: [Starting influence](../mod_hexer/content/3350421454/scripts/start_influence.as).
...
## Tools
To make development of *AngelScript* influences a little bit easier, we've prepared a file with all the exposed properties [Predefined](../mod_hexer/content/3350421454/scripts/as.predefined). 
...
## Event management
Via ```int ProcessEvent(Event@ evt, BCCGInfluenceInstanceBase@ influence)``` implemented method you will be able to receive events from other objects in the game. Be aware that some events need to be casted to more precise type if you want to make more complicated behaviours. To see all available events go to the end of [Predefined](../mod_hexer/content/3350421454/scripts/as.predefined) file.

## Examples
For more examples how influences can be made go to [Scripts directory](../mod_hexer/content/3350421454/scripts/).
